...
class TestTreatment:
    ...
    def test_entity(self):
        ...
        assert repr(t1) == "EntityTreatment(entity=NamedEntity(name='M9 Glucose CAA', reference='https://hub.sd2e.org/user/sd2e/design/M9_glucose_CAA/1'))"
    ...
    def test_simple_treatment(self):
        ...
        assert repr(
            t1) == "AttributeTreatment(attribute=BoundAttribute(name='temperature', value=Value(value=, unit=Unit(reference='http://purl.obolibrary.org/obo/UO_0000027'))))"
